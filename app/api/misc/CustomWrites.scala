...
import api.misc.Message.{Error, Failure, Success}
import api.utils.Utils.enumerationFormatter
...
object CustomWrites {
  implicit val categoryFormatter: Formatter[Category] = enumerationFormatter(CategoryImpl)
  ...
  implicit object CategoryWrites extends Writes[Category] {
    override def writes(s: Category): JsValue = JsString(s.toString)
  }
